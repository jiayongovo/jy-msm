...
public:
  ...
  public:
    ...
    inline bool is_inf() const { return (bool)((int)X.is_zero()); }
  ...
  public:
    ...
    inline bool is_inf() const { return inf; }
  ...
  template <class affine_t> inline xyzz_t &operator=(const affine_t &a) {
    X = a.X;
    Y = a.Y;
  ...
  inline void cneg(bool neg) { ZZZ.cneg(neg); }
